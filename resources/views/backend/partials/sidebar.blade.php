<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fas fa-cog fa-spin me-2"></i>Web Settings</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('admin.basicinfos.index') }}" class="dropdown-item">Basic Info</a>
                    <a href="blank.html" class="dropdown-item">Payment Icon</a>
                    <a href="blank.html" class="dropdown-item">Policy Menu</a>
                </div>
            </div>
        </div>
    </nav>
